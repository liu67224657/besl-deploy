    ...
    <td colspan="2" align="center"><br>
        <s:if test="%{operation == null}">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <form name="releaseForm" method="post" action="?env=${env}&oper=${oper}&args=${args}">
                    <tr>
                        <td>
                                ...
                                <tr class="toolbar">
                                    ...
                                    <td width="25%" align="center">
                                        ...
                                        <input name="refresh" type="button" id="refresh"
                                               ...
                                               onClick="submitOperation(document.releaseForm, 'refresh')">
                                        <input name="preview" type="button" id="preview"
                                               value='<s:text name="def.exec.preview.name"/>'
                                               onClick="submitOperation(document.releaseForm, 'preview')">
                                    </td>
                                </tr>
                            </table>
