    ...
    <td colspan="2" align="center"><br>
        <s:if test="%{operation == null}">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <form name="deployForm" method="post" action="?env=${env}&oper=${oper}&args=${args}">
                    <tr>
                        <td>
                            <table width="100%" border="1" cellspacing="0" cellpadding="1">
                                <tr class="toolbar">
                                    <td width="25%" align="right">请输入补丁的编号：</td>
                                    <td><input name="patchnum" type="text" id="patchnum" size="16" maxlength="16">
                                    </td>
                                    <td width="25%" align="center">
                                        ...
                                        <input name="refresh" type="button" id="refresh"
                                               ...
                                               onClick="submitOperation(document.deployForm, 'refresh')">
                                        <input name="preview" type="button" id="preview"
                                               value='<s:text name="def.exec.preview.name"/>'
                                               onClick="submitOperation(document.deployForm, 'preview')">
                                    </td>
                                </tr>
                            </table>
