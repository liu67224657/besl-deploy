    ...
    <td colspan="2" align="center"><br>
        <s:if test="%{operation == null}">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <form name="wsdeployForm" method="post" action="?env=${env}&oper=${oper}&args=${args}">
                    <tr>
                        <td>
                            <table width="100%" border="1" cellspacing="0" cellpadding="1">
                                <tr class="toolbar">
                                    <td width="25%" align="right">请选择需要部署的版本：</td>
                                    <td><select name="version">
                                        <s:iterator value="versions" id="ver">
                                            <option id="${ver}">${ver}</option>
                                        </s:iterator>
                                    </select></td>
                                    <td width="25%" align="center">
                                        ...
                                        <input name="refresh" type="button" id="refresh"
                                               ...
                                               onClick="submitOperation(document.wsdeployForm, 'refresh')">
                                        <input name="preview" type="button" id="preview"
                                               value='<s:text name="def.exec.preview.name"/>'
                                               onClick="submitOperation(document.wsdeployForm, 'preview')">
                                    </td>
                                </tr>
                            </table>
