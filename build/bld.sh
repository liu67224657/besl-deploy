...
setenv CLASSPATH $ANT_HOME/lib/ant.jar:$ANT_HOME/lib/ant-nodeps.jar:$ANT_HOME/lib/ant-apache-bcel.jar:$JDK_HOME/lib/tools.jar:$ANT_HOME/lib/ant-launcher.jar:$ANT_HOME/lib/ant-junit.jar
