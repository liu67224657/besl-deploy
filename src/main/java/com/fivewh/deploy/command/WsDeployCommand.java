 ...
 */
public class WsDeployCommand extends SshCommand {
    private static final String CMD_DEPLOY = "/home/ops/bin/wsdeploy";
    ...
    public WsDeployCommand(String deployOper, String deployVersion) {
